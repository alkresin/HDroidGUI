...
export NDK_OUT=obj
export SRC_FILES="../src/prg/h4droid.c hdmain.c hdactiv.c hdwidget.c drawwidg.c"
$NDK_HOME/prebuilt/linux-x86/bin/make -f $NDK_HOME/build/core/build-local.mk "$@" >a1.out 2>a2.out

cd static
export NDK_LIBS_OUT=../libs
export NDK_OUT=../obj
export SRC_FILES="../../src/prg/h4droid.c ../../jni/hdmain.c ../../jni/hdactiv.c ../../jni/hdwidget.c ../../jni/drawwidg.c"
